...
public class SlidableLayoutOld extends FrameLayout{
	...
	public SlidableLayoutOld(Context context) {
		this(context, null);
	}

	public SlidableLayoutOld(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public SlidableLayoutOld(Context context, AttributeSet attrs, int defStyleAttr) {
